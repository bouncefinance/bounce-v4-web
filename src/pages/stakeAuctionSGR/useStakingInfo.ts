...
export const useCoinToken0 = () => {
  const token0 = new Currency(ChainId.MAINNET, '0x478156DeAbfAc918369044D52A6BdB5Cc5597994', 8, 'SGR', 'SGR')
  const token1 = new Currency(ChainId.MAINNET, '0xA9B1Eb5908CfC3cdf91F9B8B3a74108598009096', 18, 'AUCTION', 'AUCTION')
  const token0Amount = CurrencyAmount.fromAmount(token0, '3000000000000')
