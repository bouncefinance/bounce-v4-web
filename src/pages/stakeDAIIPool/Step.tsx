...
import StakeDaiiInputDialog from 'bounceComponents/common/StakeDaiiInputDialog'
import {
  BoldTextStyle,
              ...
              <Stack spacing={{ xs: 20, md: 30 }}>
                <Stack direction="row" alignItems={'center'} justifyContent={'space-between'}>
                  <Stack spacing={8}>
                    ...
                    <CardLabelStyle>0.0015 DAII</CardLabelStyle>
                  </Stack>
                  <Stack spacing={8}>
                    <CardContentStyle>Total Supply of BDID</CardContentStyle>
                    <CardLabelStyle>100,000,000</CardLabelStyle>
                  </Stack>
                </Stack>
                <Stack spacing={8}>
                  ...
                  <CardLabelStyle>
                    {coinInfo?.token1Amount && token1Currency
                      ...
                      : '--'}{' '}
                    {token1Currency?.symbol} / 150,000 DAII
                  </CardLabelStyle>
                </Stack>
                <Stack spacing={8}>
  ...
  return (
    <Stack spacing={24} mt={24}>
      ...
      >
        ...
        final $BDID allocation, which will be transferred to your spot account along with your remaining $DAII.
      </Typography>
      {account &&
